...
#
# 1 день вместо 3: восстановление из корзины (WB /content/v2/cards/recover)
...
# Один день — компромисс: почти все отмены приходят в первые сутки, а карточки
# не лежат в кабинете неделями.
CANCEL_GRACE_DAYS = 1
