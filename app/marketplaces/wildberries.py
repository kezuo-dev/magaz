...
class WBClient(MarketplaceClient):
    ...
    def fetch_catalog(self) -> list[dict]:
        ...
        while True:
            ...
            # Пауза между страницами: WB лимитирует content API жёстко.
            # Без паузы 44+ страниц подряд сжигают весь rate limit токена,
            # после чего wb_trash не может пробиться и 4000+ книг зависают.
            time.sleep(0.5)
